...
/** CallSite represents a place in user code. It can have a short and a long form. */ case class CallSite(shortForm: String, longForm: String)
...
object Utils extends Logging{
 ...
 def startServiceOnPort[T](
                            ...
                            conf: util.HashMap[String,String],
  ...
  for (offset <- 0 to maxRetries) {
   ...
   try {
    ...
    case e: Exception if e.isInstanceOf[BindException] =>
